 ...
 */
router.post('/', requirePermission('admin'), (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
 ...
 * Requires admin permission
 */
router.get('/', requirePermission('admin'), (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
 ...
 * Requires admin permission
 */
router.get('/:id', requirePermission('admin'), (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
      const { id } = req.params;
 ...
 * Requires admin permission
 */
router.put('/:id/rotate', requirePermission('admin'), (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
      const { id } = req.params;
 ...
 * Requires admin permission
 */
router.delete('/:id', requirePermission('admin'), (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
      const { id } = req.params;
 ...
 * Requires admin permission
 */
router.get('/stats/usage', requirePermission('admin'), (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
 ...
 */
router.get('/test/current', (req: AuthenticatedRequest, res, next) => {
  void (async () => {
    try {
      const response = {
        success: true,
