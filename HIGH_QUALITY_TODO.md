...
_This TODO list should be worked through systematically, one item at a time, with proper testing and validation at each step. Each task includes specific implementation details, validation criteria, and time estimates to ensure successful completion._
