...
if (!tasks || !('data' in tasks) || !tasks.data || (Array.isArray(tasks.data) && tasks.data.length === 0)) {
...
```typescript
// Before
function createTask(title: string, description: string, boardId: string, columnId: string, priority: number, dueDate?: Date, assignee?: string) {
  // ...
}
