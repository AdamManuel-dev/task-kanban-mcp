...
describe('CircuitBreaker', () => {
  ...
  describe('execute', () => {
    ...
    it.skip('should handle operation timeout', async () => {
      // TODO: Fix circuit breaker timeout implementation - currently hangs indefinitely
...
describe('BulkheadIsolation', () => {
  ...
  describe('execute', () => {
    ...
    it.skip('should queue operations when at concurrency limit', async () => {
      // TODO: Fix bulkhead queue implementation - currently hangs in test environment
    ...
    it('should reject when queue is full', async () => {
      const longOperation = async () => new Promise(resolve => setTimeout(resolve, 1000));

      // Fill up concurrency and queue
      const promises = Array(6)
        .fill(0)
        .map(async () => bulkhead.execute(longOperation));
    ...
    it.skip('should handle operation timeout', async () => {
      // TODO: Fix bulkhead timeout implementation - currently hangs indefinitely
      const slowOperation = async () => new Promise(resolve => setTimeout(resolve, 2000));

      await expect(bulkhead.execute(slowOperation)).rejects.toThrow('Operation timed out');
    }, 30000);
  });
...
describe('HealthMonitor', () => {
  ...
  describe('registerHealthCheck', () => {
    it.skip('should register and perform health check', async () => {
      // TODO: Fix health monitor timing issues in test environment
    ...
    it.skip('should handle failing health checks', async () => {
      // TODO: Fix health monitor timing issues in test environment
...
describe('ErrorRecoveryManager', () => {
  ...
  describe('executeWithRecovery', () => {
    ...
    it.skip('should retry on recoverable errors', async () => {
      // TODO: Fix error recovery manager timing issues in test environment
      const mockOperation = jest
        .fn()
    ...
    it('should not retry on non-recoverable errors', async () => {
      ...
      await expect(
        errorRecoveryManager.executeWithRecovery(mockOperation, {
          maxRetries: 2,
        })
  ...
  describe('addErrorPattern', () => {
    it('should add custom error pattern', async () => {
      ...
      const mockOperation = jest.fn().mockRejectedValue(new Error('Custom error occurred'));
